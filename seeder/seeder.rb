pages << {
  ...
  # url: "https://www.amazon.com/s?k=lcd+%26+led+tv&rh=n%3A1266092011&ref=nb_sb_noss",
  vars: {
    category: "LED & LCD TVs"
  }
  # url: "https://www.amazon.com/s?k=lcd+%26+led+tv&i=electronics&rh=n%3A1266092011&qid=1716820752&ref=sr_pg_1"
}
pages << {
  page_type: 'listings',
  method: "GET",
  ...
  # url: "https://www.amazon.com/s?k=oled+tv%27s&rh=n%3A1266092011&ref=nb_sb_noss",
  vars: {
    category: "OLED TVs"
  }
}
